...
import com.alvarolc.aad_playground.commons.serializer.JsonSerializer
 ...
 * @see com.alvarolc.aad_playground.ut03.ex05.data.local.xml.AlertXmlExtraLocalSource
 */
class AlertXmlLocalSource(private val context: Context,
                          private val serializer: JsonSerializer) : AlertLocalSource {

    private val nameXmlFile = "ut03_ex05_alerts"
